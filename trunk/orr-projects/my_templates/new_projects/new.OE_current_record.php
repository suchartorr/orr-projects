 ...
 */
$event_link = '<a href="my_group.php?val_filter[sys_id]=' . $EV_record[sys_id] . '&val_msg[btn_filter]=Filter" target="_parent" >' . $EV_record[sys_id] . '</a>';
$this->controls[sys_id]->OP_[text]->set($event_link);
